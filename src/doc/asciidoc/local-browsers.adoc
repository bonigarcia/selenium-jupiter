...
NOTE: Chrome options (arguments only) and Firefox profiles can be configure in Selenide using JVM properties using the command line as `-Dchromeoptions.args=,...` and `-Dfirefoxprofile.=,`.
