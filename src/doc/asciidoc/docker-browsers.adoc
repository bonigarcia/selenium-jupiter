...
NOTE: Notice that the version of the second test is simply `57`. The actual version of the image is `57.0`, but _Selenium-Jupiter_ supposes that version is `.0` if not specified.
...
[INFO]
[INFO] ------------------------------------------------------------------------
[INFO] Building selenium-jupiter 2.1.1-SNAPSHOT
[INFO] ------------------------------------------------------------------------
[INFO]
...
[INFO] Starting Docker container aerokube/selenoid:1.5.3
...
[INFO] Stopping Docker container aerokube/selenoid:1.5.3
...
[source]
----
$ java -jar selenium-jupiter-2.1.1-SNAPSHOT-jar-with-dependencies.jar firefox
