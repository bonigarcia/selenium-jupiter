...
NOTE: _Selenium-Jupiter_ 3.3.5 depends on *_selenium-java_ 3.141.59*, *_webdrivermanager_ 4.2.0*, *appium _java-client_ 7.3.0*, *spotify _docker-client_ 8.16.0*, *_htmlunit_ 2.36.0*, and *selenide 5.14.2*. Therefore, by using the _Selenium-Jupiter_ dependency, these libraries will be added as transitive dependencies to your project.
