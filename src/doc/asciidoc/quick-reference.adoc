...
NOTE: _Selenium-Jupiter_ 3.3.0 depends on *_selenium-java_ 3.141.59*, *_webdrivermanager_ 3.4.0*, *appium _java-client_ 7.0.0*, and *spotify _docker-client_ 8.15.1*. Therefore, by using the _Selenium-Jupiter_ dependency, these libraries will be added as transitive dependencies to your project.
