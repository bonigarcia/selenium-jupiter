...
NOTE: _Selenium-Jupiter_ 3.3.3 depends on *_selenium-java_ 3.141.59*, *_webdrivermanager_ 3.8.0*, *appium _java-client_ 7.0.0*, *spotify _docker-client_ 8.16.0*, *_htmlunit_ 2.36.0*, and *selenide 5.6.0*. Therefore, by using the _Selenium-Jupiter_ dependency, these libraries will be added as transitive dependencies to your project.
