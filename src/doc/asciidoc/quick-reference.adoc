...
NOTE: _selenium-jupiter_ 1.0.0 depends on *_selenium-java_ 3.4.0* and *_webdrivermanager_ 1.7.1*. Therefore, by using the _selenium-jupiter_ dependency, those libraries (_selenium-java_ and _webdrivermanager_) will be added as transitive dependencies to your project.
