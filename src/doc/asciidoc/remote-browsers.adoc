...
_Selenium-Jupiter_ also supports remote browsers, using http://www.seleniumhq.org/projects/grid/[Selenium Grid]). To that aim, a couple of custom annotations can be used:
